...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('stage_questionnaire_assignments', function (Blueprint $table): void {
            ...
            $table->foreignId('questionnaire_template_id')->constrained('questionnaire_templates', 'id', 'sqa_template_fk')->cascadeOnDelete();
            $table->boolean('is_required')->default(true);
            $table->timestamps();

            $table->unique(['workflow_stage_id', 'questionnaire_template_id'], 'sqa_stage_template_unique');
        });
    }
